(function ($) {
    ...
    // :: 2.0 Nav Active Code
    if ($.fn.classyNav) {
        $('#bravarija-gajaninNav').classyNav();
    }
    ...
    if ($.fn.imagesLoaded) {
        $('.bravarija-gajanin-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.bravarija-gajanin-portfolio').isotope({
    ...
    if ($.fn.sticky) {
        $(".bravarija-gajanin-main-menu").sticky({
            topSpacing: 0
        });
    }
